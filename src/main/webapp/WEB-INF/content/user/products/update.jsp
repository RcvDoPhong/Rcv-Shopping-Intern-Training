<%@ taglib prefix="s" uri="/struts-tags" %>
    <form enctype="multipart/form-data" method="POST" action="/user/products/update" id="productForm">
        <input type="hidden" name="productForm.productId" value="${productForm.productId}">
        <!-- <== Security issues!!-->
        <div class="row media">
            <div class="col-6">
                <div class="form-group">
                    <label class="mt-2 d-flex">Product name</label>
                    <input name="productForm.productName" id="name" type="text" class="form-control d-flex"
                        value="${productForm.productName}" placeholder="Type product name">
                    <span class="error validation invalid-feedback" id="name"></span>
                </div>
                <div class="form-group">
                    <label class="mt-2 d-flex">Product price (USD)</label>
                    <input name="productForm.productPrice" id="price" type="number" class="form-control d-flex"
                        value="${productForm.productPrice}" placeholder="Type product price">
